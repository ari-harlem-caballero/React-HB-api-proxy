  ...
  return (
    <section className='pokemon'>
      ...
      <form onSubmit={handlePokemonSubmit}>
            Search pokemon
        {/* add inputs/labels for pokemon NAME, using all the things we need with react forms. Don't forget to use the value property to sync these up with the default values in react state */}
        <input
